...
export default function InvitePage() {
  ...
  // STEP 2: Verify OTP (supports manual submit, onPaste, and auto-submit on 6th digit)
    ...
    return (
      <div className="min-h-screen bg-[#F7F4EC] text-[#29352F] flex flex-col items-center justify-center p-4">
        <div className="text-center">
          <div className="w-12 h-12 border-4 border-[#6F8F7A] border-t-transparent rounded-full animate-spin mx-auto mb-4" />
          <p className="font-bold text-[#6B7C73]">Checking your invitation...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-[#F7F4EC] text-[#29352F] flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md bg-[#FFFDF7] border-2 border-[#EBE6D8] rounded-3xl p-8 text-center shadow-sm">
          ...
          <h1 className="text-2xl font-extrabold text-[#29352F] mb-2">Invitation Unavailable</h1>
          <p className="text-sm text-[#6B7C73] leading-relaxed mb-6">{inviteError}</p>
          <div className="flex flex-col gap-2">
            <Link
              href="/login"
              className="py-3 px-4 bg-[#6F8F7A] hover:bg-[#5C7966] text-white font-bold rounded-xl text-center no-underline transition-colors"
            >
              Go to Login
            </Link>
            <Link
              href="/"
              className="py-2.5 px-4 text-sm text-[#6B7C73] hover:text-[#29352F] font-semibold text-center no-underline"
            >
              Back to Home
            </Link>
          </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          <Link href="/" className="inline-flex items-center gap-2 mb-3 no-underline group">
            ...
            />
            <span className="text-2xl font-extrabold text-[#29352F] tracking-tight">Cognia</span>
          </Link>
        </div>
        ...
        <div className="bg-[#FFFDF7] border-2 border-[#EBE6D8] rounded-3xl p-6 sm:p-8 shadow-sm">
          ...
          <div className="p-4 bg-[#E8EFEA] border border-[#C5D7CC] rounded-2xl mb-6 text-center">
            <div className="flex items-center justify-center gap-2 text-xs font-bold text-[#425B4C] uppercase tracking-wider mb-1">
              <HeartHandshake size={16} className="text-[#6F8F7A]" />
              <span>Personal Invitation</span>
            </div>
            <h2 className="text-lg font-extrabold text-[#29352F]">
              Welcome to Cognia!
            </h2>
            <p className="text-xs text-[#52685B] mt-1 font-medium">
          ...
          {signupStep === 'details' && (
            <form onSubmit={handleSignupSubmit} className="flex flex-col gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-[#6B7C73] mb-3">
                  Joining as a patient linked with <strong className="text-[#29352F]">{caregiverName}</strong>
                </p>
              </div>
          ...
          <div className="mt-6 pt-4 border-t border-[#EAE5D9] text-center">
            <Link href="/login" className="text-xs font-bold text-[#6F8F7A] hover:underline">
